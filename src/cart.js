...
const createCartItems = function (element, index, category) {
    return _.template(`<li name='todo-item' id='catalogue${index}' class='py-2 list-group-item" w-75  pr-2'> Buy <%= item %> - <input type="number"  class="form-control h-75 float-right d-inline  w-25 itemsChosen" value='' name= '${category}_<%= item %>' placeholder='Enter quantity' > </li>`)(element);
}
